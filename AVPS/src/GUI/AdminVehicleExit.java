 ...
 */
public class AdminVehicleExit extends javax.swing.JFrame {

    /**
     * Creates new form AdminVehicleExit
     */
    public AdminVehicleExit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel17.setText("__________");

        jButton3.setText("Print Bill");

        jButton4.setText("Collect Money");

        jLabel18.setText("Out Date & Time:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminVehicleExit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminVehicleExit().setVisible(true);
            }
        });
    }
